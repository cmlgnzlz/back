...
class Producto{
    ...
    async getAll(carrId){
        try {
            ...
            let userData = await this.Carro.getUserInfo(carrId);
            this.datos = datos;
    ...
    static validar(producto, requerido) {
        const productoSchema = Joi.object({
          ...
          qty: requerido ? Joi.number().required() : Joi.number(),
          img: requerido ? Joi.string().required() : Joi.string(),
          desc: requerido ? Joi.string().required() : Joi.string(),
        });
